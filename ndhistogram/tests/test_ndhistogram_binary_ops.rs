use ndhistogram::{axis::Uniform, ndhistogram, Histogram, VecHistogram};
...
type Hist1D = VecHistogram<(Uniform<f64>,), f64>;
type Hist3D = VecHistogram<(Uniform<f64>, Uniform<f64>, Uniform<f64>), f64>;
