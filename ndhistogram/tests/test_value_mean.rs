use ndhistogram::{axis::Uniform, ndhistogram, value::Mean, AxesTuple, Histogram, VecHistogram};
...
fn simple_filled_float_mean_hist() -> VecHistogram<AxesTuple<(Uniform,)>, Mean> {
...
fn simple_filled_int_mean_hist() -> VecHistogram<AxesTuple<(Uniform,)>, Mean<i32>> {
