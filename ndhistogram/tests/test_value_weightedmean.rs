use ndhistogram::{
    axis::Uniform, ndhistogram, value::WeightedMean, AxesTuple, Histogram, VecHistogram,
};
...
) -> VecHistogram<AxesTuple<(Uniform,)>, WeightedMean<f64, f64>> {
...
) -> VecHistogram<AxesTuple<(Uniform,)>, WeightedMean<i32, i32>> {
...
) -> VecHistogram<AxesTuple<(Uniform,)>, WeightedMean<f64, f64, f64, u32>> {
